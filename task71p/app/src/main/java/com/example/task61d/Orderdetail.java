...
public class Orderdetail extends AppCompatActivity {
    TextView name, phone, location, date, description, type;
    Button Remove;
    String name1, phone1, location1, date1, description1, type1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        date1 = cursor.getString(cursor.getColumnIndexOrThrow("data"));
